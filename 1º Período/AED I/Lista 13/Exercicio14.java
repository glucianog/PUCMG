...
class PessoaFisica extends Pessoa{
   ...
   PessoaFisica(double cpf,String nome, Data nascimento){
...
class PessoaJuridica extends Pessoa{
   ...
   PessoaJuridica(double cnpj,String nome, Data nascimento){
      super(nome,nascimento);
      setCnpj(cnpj);
   }
...
class Menu{
  ...
  public void menu(){
   ...
   public void lePessoaFisica()throws ArrayIndexOutOfBoundsException, InputMismatchException{
      Scanner scanner = new Scanner(System.in);
      ...
      pessoas[posicao] = new PessoaFisica(cpf,nome,nascimento);
      posicao++;
   }
   public void lePessoaJuridica()throws ArrayIndexOutOfBoundsException, InputMismatchException{
      Scanner scanner = new Scanner(System.in);
      System.out.println("Digite o nome da pessoa");
      String nome = scanner.nextLine();      
      int dia,
      ...
      cnpj = scanner.nextDouble();
           
      Data nascimento = new Data();
      nascimento.setDia(dia);
      nascimento.setMes(mes);
      nascimento.setAno(ano);      
      pessoas[posicao] = new PessoaJuridica(cnpj,nome,nascimento);
      posicao++;
   }
