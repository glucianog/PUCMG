...
class Hash{
    ...
    /**
     * Método para calcular a posiçao rehash
     * @param id int ID da pessoa a ser inserida
     * @return posição rehash após calculado a posição com a função
     */
    public int func_rehash(int id){
        return (id+1) % this.tamanho;
    }
