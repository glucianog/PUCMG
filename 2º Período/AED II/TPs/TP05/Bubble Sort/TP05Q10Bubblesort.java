/**
 * TP05Q01 Ordenação Bubblesort por ano de nascimento.
 * @author Gabriel Luciano Gomes
 * @version 1 09/2016
 */
import java.util.*;
import java.io.*;
class TP05Q10Bubblesort{
...
class Lista {
    ...
    public void bolha() {
        for (int i = (getN() - 1); i > 0; i--) {
            for (int j = 0; j < i; j++) {
                String localdir = array[j].getLocalNascimento();
                String localesq = array[j+1].getLocalNascimento();
