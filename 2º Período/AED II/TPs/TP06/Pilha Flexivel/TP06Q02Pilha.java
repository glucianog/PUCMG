...
class Pilha {
    ...
    /**
     * Remove Pessoa da pilha (politica FILO).
     * @return Pessoa removida.
     * @trhows Exception Se a sequencia nao contiver pessoas.
     */
